...
>
> **Not yet individually verified (expect mostly already-fixed; check in code):** `ArmyData:2668`, `Cell:342/984` (DB Get on valid good/terrain indices — low-risk), `CityData:1198/841/946`, `CityInfluenceIterator:234`, `Goal` cluster (2185/2487/2513/2795 + GetCityData ×7), `Player` alliance (4085/4118), `SlicFunc:6436/7397`, `SlicSymbol:534/621`, `aui_tipwindow:87`, `background:372`, `c3cmdline:3168`, `c3fancywindow:236`, `UnitActor:1546`. `C3Robot`/`GWArchive`/`GWFile` absent; `net_*` deferred.
