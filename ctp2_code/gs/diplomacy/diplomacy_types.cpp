...
void DiplomatTypes::InitializeSlicConsts() {
	...
	slicengine_Get()->AddConst("MIN_REGARD", MIN_REGARD);
	slicengine_Get()->AddConst("HOTWAR_REGARD", HOTWAR_REGARD);
	slicengine_Get()->AddConst("COLDWAR_REGARD", COLDWAR_REGARD);
	slicengine_Get()->AddConst("NEUTRAL_REGARD",NEUTRAL_REGARD);
	slicengine_Get()->AddConst("FRIEND_REGARD", FRIEND_REGARD);
	slicengine_Get()->AddConst("ALLIED_REGARD", ALLIED_REGARD);
	slicengine_Get()->AddConst("MAX_REGARD", MAX_REGARD);
	...
	for ( i = 0; i < REGARD_EVENT_MAX; i++) {
		...
		slicengine_Get()->AddConst(fullname.c_str(), i);
	}
