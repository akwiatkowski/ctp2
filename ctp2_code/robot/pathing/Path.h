...
//
// - SnipEndUntilCanEnter now returns the end MapPoint. (30-Jan-2008 Martin G�hmann)
// - SnipEndUntilCanEnter is now base on the army's ability to enter cell
//   and not based on its movement type. (8-Feb-2008 Martin G�hmann)
//
//----------------------------------------------------------------------------
...
public:
	...
	// JSON bridge — mirrors Path::Serialize.  Persists start/current
