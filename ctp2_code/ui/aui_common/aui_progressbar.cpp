...
AUI_ERRCODE aui_ProgressBar::InitCommonLdl( MBCHAR const *ldlBlock )
{
	...
	MBCHAR const *keyword = block->GetString( k_AUI_PROGRESSBAR_LDL_ORIENTATION );
	if ( !keyword )
...
aui_Image *aui_ProgressBar::SetBarImage( MBCHAR const *image )
{
