...
//   (L. Hirth 6/2004)
// - Entrenching units are treated like Entrenched units. (Oct 16th 2005 Martin G�hmann)
// - Added select city instead of army option. (Oct 16th 2005 Martin G�hmann)
// - Added option to avoid an end turn if there are cities with empty build
//   queues. (Oct. 22nd 2005 Martin G�hmann) Doesn't really work.
...
//   center option is active. (23-Feb-2008 Martin G�hmann)
//
//----------------------------------------------------------------------------
