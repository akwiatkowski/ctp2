...
{
	// Opt-in: restored fogged games still expose whole-map cache corruption on
	// real desktop sessions. CTP2_GPU_WORLDMAP=1 enables continued development;
	// the proven window mirror remains the default renderer.
	static int s_enabled = -1;
	if (s_enabled < 0)
	{
