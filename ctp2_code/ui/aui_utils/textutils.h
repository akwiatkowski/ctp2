...
sint32	textutils_GetFontHeight(aui_Surface *pDirectSurface, uint32 size);
HFONT	textutils_GetFont(aui_Surface *pDirectSurface, uint32 size);

RECT	textutils_GetBounds(aui_Surface *pDirectSurface, const MBCHAR *pString);
RECT	textutils_CenterText(aui_Surface *pDirectSurface, const MBCHAR *pString,
					  RECT *pDestRect);

void	textutils_AddFont(const MBCHAR *szFileName);
void	textutils_RemoveFont(const MBCHAR *szFileName);
HFONT	textutils_CreateFont(aui_Surface *pDirectSurface, const MBCHAR *szFaceName,
...
void	textutils_TestFonts(aui_Surface *pDirectSurface);
