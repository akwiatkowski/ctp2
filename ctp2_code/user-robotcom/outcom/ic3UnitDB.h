...
DECLARE_INTERFACE_(IC3UnitDB, IUnknown)
{
    ...
    STDMETHOD_ (BOOL, IsTrader)(THIS_ sint32 type_unit) PURE;
	...
	STDMETHOD_ (BOOL, IsMoveAir)(THIS_ sint32 type_unit) PURE;
	STDMETHOD_ (BOOL, IsMoveLand)(THIS_ sint32 type_unit) PURE;
	STDMETHOD_ (BOOL, IsMoveWater)(THIS_ sint32 type_unit) PURE;
	STDMETHOD_ (BOOL, IsMoveSpace)(THIS_ sint32 type_unit) PURE;
	STDMETHOD_ (BOOL, IsMoveMountain)(THIS_ sint32 type_unit) PURE;
	STDMETHOD_ (BOOL, IsMoveShallowWater)(THIS_ sint32 type_unit) PURE;
