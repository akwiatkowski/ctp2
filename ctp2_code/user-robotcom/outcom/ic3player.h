...
STDMETHOD_ (BOOL, CanParadropNow) (THIS_ BOOL *is_unknown_id, uint32 u_id) PURE;
     ...
     STDMETHOD_ (void, RemoveCityPopFromMap) (THIS_
         uint32 city_id,
         BOOL *is_unknown_id
         ) PURE;
     ...
     STDMETHOD_ (void, GetCityCrimePrevention)(THIS_ uint32 city_id, BOOL *is_unknown_id,
        double *cop) PURE;
     STDMETHOD_ (void, GetCityMusicianHappiness)(THIS_ uint32 city_id, BOOL *is_unknown,
        double *musician) PURE;
     ...
     STDMETHOD_ (BOOL, GetCityPopAffect) (THIS_ uint32 city_id,
         BOOL *is_unknown_id, sint32 *pop_affect) PURE;

    STDMETHOD_ (long, GetCitySizePopEffect) (THIS_ uint32 city_id,
         BOOL *is_unknown_id, sint32 *city_size_pop_effect) PURE;

     STDMETHOD_ (BOOL, GetCityFieldCitizenPop) (THIS_ uint32 city_id, BOOL *is_unknown_id,
        sint32 *field_citizen_pop) PURE;
